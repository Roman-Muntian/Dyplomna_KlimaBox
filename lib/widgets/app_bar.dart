// =====================================================================
//  BRUTALIST APP BAR — верхня панель головного екрана
//
//  Містить кнопку відкриття бокового меню і назву додатка.
//  onMenuTap — опціональний колбек перед відкриттям Drawer.
// =====================================================================
    ...
    return Container(
      ...
      child: SafeArea(
        child: Padding(
          ...
          child: Row(
            children: [
              // Builder потрібен щоб отримати ScaffoldState для openDrawer()
              Builder(
