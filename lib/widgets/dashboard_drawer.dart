// =====================================================================
//  DASHBOARD DRAWER — бокове меню
//
//  Навігація: Налаштування, Журнал, Аналітика, Експорт CSV.
//  Стан підключення передається як параметр — без StreamBuilder.
// =====================================================================
...
class DashboardDrawer extends StatelessWidget {
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  Text(t('main_menu'), style: NB.label(11, weight: FontWeight.w900)),
                  ...
                  Text(t('export_section'), style: NB.label(11, weight: FontWeight.w900)),
                  const SizedBox(height: 12),
            ...
            // Підвал з назвою додатка
            Container(
              width:   double.infinity,
              padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 14),
              decoration: BoxDecoration(
                color:  NB.white,
                border: Border(top: BorderSide(color: NB.ink, width: NB.borderThick)),
              ),
              child: Row(
                ...
                children: [
                  ...
                  Text('KlimaBox', style: NB.label(11, weight: FontWeight.w900)),
                ],
              ),
            ),
          ],
  ...
  // Шапка з іменем користувача і тегом статусу підключення
  Widget _buildHeader() {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              NeoTag(label: t('user_group'), color: NB.neonYellow, textColor: Colors.black),
              const SizedBox(width: 8),
              statusTag,
            ],
          ),
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            // Іконка у білій рамці
            Container(
              width: 38, height: 38,
              decoration: nbBlock(color: NB.white, radius: 4, shadow: NB.hardShadowNone, borderWidth: NB.borderThin),
            ...
            Expanded(
              child: Column(
                ...
                mainAxisAlignment:  MainAxisAlignment.center,
                children: [
                  Text(title, style: NB.body(14, weight: FontWeight.w800, color: tc), maxLines: 1, overflow: TextOverflow.ellipsis),
                  if (subtitle != null) ...[
                    const SizedBox(height: 2),
                    Text(subtitle!.toUpperCase(), style: NB.label(9.5, color: tc, weight: FontWeight.w800)),
                  ],
                ],
              ),
            ),
